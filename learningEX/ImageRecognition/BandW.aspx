<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BandW.aspx.cs" Inherits="learningEX.ImageRecognition.BandW" %>
...
<body>
    <form id="form1" runat="server" enctype="multipart/form-data">
        <div>
            ...
            <asp:Button ID="Button1" runat="server" Text="上傳並轉換" OnClick="Button1_Click" />
